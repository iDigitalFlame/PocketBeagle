...
/usr/bin/printf '[Match]\nType                = gadget\n\n[Network]\nDNS                 = 10.1.1' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/network/usb0.network"
/usr/bin/printf '0.2\nAddress             = 10.1.10.1/30\nIPv6AcceptRA        = no\nLinkLocalAddr' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/network/usb0.network"
/usr/bin/printf 'essing = no\n\n[Route]\nGateway             = 10.1.10.1\n' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/network/usb0.network"
