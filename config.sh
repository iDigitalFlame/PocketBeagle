...
/usr/bin/printf 'fs.file-max                     = 372925\nkernel.sysrq                    = 0\nv' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'm.swappiness                   = 10\nfs.suid_dumpable                = 0\nfs.pro' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'tected_fifos              = 1\nfs.protected_regular            = 1\nkernel.kptr_' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'restrict            = 2\nkernel.dmesg_restrict           = 1\nfs.protected_symli' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'nks           = 1\nfs.protected_hardlinks          = 1\nkernel.yama.ptrace_scope' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf '        = 3\nkernel.kexec_load_disabled      = 1\nfs.inotify.max_user_watches   ' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf '  = 16777215\nfs.inotify.max_queued_events    = 32767\nvm.dirty_writeback_centis' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'ecs    = 1500\nfs.inotify.max_user_instances   = 4096\n' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
...
/usr/bin/printf '       = 10.1.10.1\n' >> "${SETUP_DIRECTORY}/etc/systemd/network/usb0.network"
