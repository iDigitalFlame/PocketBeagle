...
/usr/bin/printf 'DNSSEC                      = allow-downgrade\nDomains                     = usb' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/resolved.conf"
/usr/bin/printf '\nDNSOverTLS                  = no\nFallbackDNS                 = 127.0.0.1\nRea' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/resolved.conf"
/usr/bin/printf 'dEtcHosts                = yes\nMulticastDNS                = no\nDNSStubListene' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/resolved.conf"
...
/usr/bin/printf 'host\n\n10.1.10.1   beagle.usb          beagle\n10.1.10.2   host.usb            ' >> "${ROOT}${SYSCONFIG_DIR}/etc/hosts"
