...
/usr/bin/printf ' "/etc/security"\nchmod 0444 "/etc/resolv.conf"\nchmod 0500 "/etc/mkinitcpio.d" ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '2> /dev/null\nchmod 0500 "/etc/pacman.d/hooks" 2> /dev/null\nchmod 0500 "/etc/se' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'curity/limits.d" 2> /dev/null\n\nchmod 0400 /etc/sysctl.d/*\nchmod 0400 /etc/mki' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'nitcpio.d/* 2> /dev/null\nchmod 0444 /etc/systemd/network/* 2> /dev/null\nchmod ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '0400 /etc/security/limits.d/* 2> /dev/null\n\nchown -R root:root "/etc/ssh"\ncho' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'wn -R root:root "/etc/systemd"\nchown -R root:root "/etc/sysctl.d"\nchown -R roo' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 't:root "/etc/security"\nchown -R root:root "/etc/profile.d"\nchown -R root:root ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"/etc/syscheck.d"\nchown -R root:root "/etc/resolv.conf"\n\nfind "/etc/ssh" -typ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'e f -exec chmod 0400 {} \\;\nfind "/etc/systemd" -type f -exec chmod 0444 {} \\;' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nfind "/etc/security" -type f -exec chmod 0440 {} \\;\n\nif [ -e "/etc/pacman.c' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'onf" ]; then\n    chmod 0444 "${SYSCONFIG}/etc/pacman.conf"\n    chmod 0500 "${S' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'YSCONFIG}/etc/pacman.d/hooks"\n    chmod 0400 "${SYSCONFIG}"/etc/pacman.d/hooks/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '*\n    chmod 0555 "/etc/pacman.d"\n    chmod 0400 /etc/pacman.d/hooks/*\n    cho' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'wn -R root:root "/etc/pacman.d"\n    find "/etc/pacman.d" -maxdepth 1 -type f -e' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'xec chmod 0444 {} \\;\nfi\nif [ -e "${SYSCONFIG}/etc/udev" ]; then\n    chown -R' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' root:root "/etc/udev"\n    chmod -R 0555 "${SYSCONFIG}/etc/udev"\n    find "/et' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c/udev/" -xdev -type f -exec chmod 0444 {} \\;\nfi\nif [ -e "${SYSCONFIG}/etc/tm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'pfiles.d" ]; then\n    chown -R root:root "/etc/tmpfiles.d"\n    chmod 0550 "${S' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'YSCONFIG}/etc/tmpfiles.d"\n    chmod 0440 "${SYSCONFIG}"/etc/tmpfiles.d/*\n    c' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'hmod 0550 "/etc/tmpfiles.d"\n    chmod 0440 /etc/tmpfiles.d/*\nfi\nif [ -e "${SY' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'SCONFIG}/etc/modprobe.d" ]; then\n    chown -R root:root "/etc/modprobe.d"\n    ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod 0500 "${SYSCONFIG}/etc/modprobe.d"\n    chmod 0400 "${SYSCONFIG}"/etc/modp' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'robe.d/*\n    chmod 0500 "/etc/modprobe.d"\nfi\nif [ -e "${SYSCONFIG}/etc/sysupd' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ate.d" ]; then\n    chown -R root:root "/etc/sysupdate.d"\n    chmod 0550 "${SYS' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'CONFIG}/etc/sysupdate.d"\n    chmod 0550 "${SYSCONFIG}"/etc/sysupdate.d/*\n    c' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'hmod 0550 "/etc/sysupdate.d"\nfi\nif [ -e "${SYSCONFIG}/etc/nftables.conf" ]; th' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'en\n    chmod 0400 "${SYSCONFIG}/etc/nftables.conf"\nfi\n\nif [ -d "/etc/syschec' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'k.d" ]; then\n    for entry in /etc/syscheck.d/*.sh; do\n        if [ -f "$entry' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '" ]; then\n            printf '\''Processing script "%%s"..\\n'\'' "$entry"\n   ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '         source "$entry"\n        fi\n    done\nfi\n\nsync\necho "Broken Links F' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ound:"\nfind /etc -xtype l -xdev 2> /dev/null | grep -vE "/proc|/tmp|/run"\necho' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' "Done!"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
