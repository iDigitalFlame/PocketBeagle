...
/usr/bin/printf 'od -R 0500 "${SYSCONFIG}/etc/syscheck.d"\nchmod -R 0550 "${SYSCONFIG}/etc/modpro' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'be.d"\n\nchmod 0555 "${SYSCONFIG}/etc/ssh"\nchmod 0500 "${SYSCONFIG}/etc/sysctl.' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'd"\nchmod 0500 "${SYSCONFIG}/etc/security"\nchmod 0500 "${SYSCONFIG}/etc/iptable' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 's"\nchmod 0500 "${SYSCONFIG}/etc/pacman.d/hooks"\nchmod 0400 "${SYSCONFIG}/etc/m' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'kinitcpio.conf"\nchmod 0440 "${SYSCONFIG}/etc/ssh/sshd_config"\nchmod 0500 "${SY' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'SCONFIG}/etc/security/limits.d"\nchmod 0400 "${SYSCONFIG}/etc/sysctl.d/kernel.co' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'nf"\nchmod 0400 "${SYSCONFIG}/etc/systemd/coredump.conf"\nchmod 0400 "${SYSCONFI' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'G}/etc/iptables/iptables.rules"\nchmod 0400 "${SYSCONFIG}/etc/iptables/ip6tables' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '.rules"\nchmod 0400 "${SYSCONFIG}/etc/security/limits.d/limits.conf"\n\nchmod 04' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '00 "${SYSCONFIG}"/etc/iptables/*\nchmod 0400 "${SYSCONFIG}"/etc/pacman.d/hooks/*' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '\n\nchmod 0400 /etc/iptables/*\nchmod 0400 /etc/pacman.d/hooks/*\n\nchmod -R 055' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '5 "/etc/profile.d"\nchmod -R 0500 "/etc/syscheck.d"\n\nchmod 0555 "/etc/ssh"\nch' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'mod 0555 "/etc/systemd"\nchmod 0500 "/etc/sysctl.d"\nchmod 0500 "/etc/iptables"\n' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'chmod 0500 "/etc/security"\nchmod 0500 "/etc/pacman.d/hooks"\nchmod 0500 "/etc/s' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'ecurity/limits.d"\n\nchmod 0444 "/etc/motd"\nchmod 0444 "/etc/hosts"\nchmod 0550' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf ' "/etc/pacman.d"\nchmod 0444 "/etc/hostname"\nchmod 0444 "/etc/locale.gen"\nchmo' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'd 0444 "/etc/resolv.conf"\nchmod 0400 "/etc/pacman.conf"\nchmod 0444 "/etc/nsswi' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'tch.conf"\nchmod 0400 "/etc/vconsole.conf"\nchmod 0444 "/etc/sysconfig.conf"\nch' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'mod 0444 "/etc/ssh/ssh_config"\nchmod 0400 "/etc/mkinitcpio.conf"\n\nchown -R ro' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'ot:root "/etc/systemd"\nchown -R root:root "/etc/iptables"\nchown -R root:root "' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '/etc/pacman.d"\nchown -R root:root "/etc/security"\nchown -R root:root "/etc/sys' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'ctl.d"\nchown -R root:root "/etc/profile.d"\nchown -R root:root "/etc/syscheck.d' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '"\n\nchown root:root "/etc/motd"\nchown root:root "/etc/hosts"\nchown root:root ' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '"/etc/hostname"\nchown root:root "/etc/locale.gen"\nchown root:root "/etc/resolv' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '.conf"\nchown root:root "/etc/pacman.conf"\nchown root:root "/etc/vconsole.conf"' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '\nchown root:root "/etc/nsswitch.conf"\nchown root:root "/etc/sysconfig.conf"\nc' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'hown root:root "/etc/mkinitcpio.conf"\n\nfind "/etc/ssh" -type f -exec chmod 040' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '0 {} \\;\nfind "/etc/systemd" -type f -exec chmod 0444 {} \\;\nfind "/etc/pacman' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '.d" -type f -exec chmod 0440 {} \\;\nfind "/etc/sysctl.d" -type f -exec chmod 04' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '40 {} \\;\nfind "/etc/security" -type f -exec chmod 0440 {} \\;\nfind "/etc/modp' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'robe.d" -type f -exec chmod 0440 {} \\;\nfind "/etc/systemd/network" -type f -ex' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'ec chmod 0444 {} \\;\n\nif [ -d "/etc/syscheck.d" ]; then\n    for entry in /etc' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf '/syscheck.d/*.sh; do\n        if [ -f "$entry" ]; then\n            source "$ent' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
/usr/bin/printf 'ry"\n        fi\n    done\nfi\n\necho "Broken Links Found:"\nfind /etc -xtype l ' >> "${ROOT}${SYSCONFIG_DIR}/bin/syslink"
...
/usr/bin/printf '[Match]\nType                    = gadget\n\n[Link]\nActivationPolicy        = a' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/network/usb0.network"
/usr/bin/printf 'lways-up\n\n[Network]\nDNS                     = 10.1.10.2\nAddress             ' >> "${ROOT}${SYSCONFIG_DIR}/etc/systemd/network/usb0.network"
...
/usr/bin/printf 'no-ping\nbind-dynamic\nexpand-hosts\ndnssec-no-timecheck\n\nport            = 53' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf '\nuser            = dnsmasq\ngroup           = dnsmasq\nlocal           = /usb/\n' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf 'domain          = usb,10.1.10.1/30\naddress         = /beagle.usb/10.1.10.1\nadd' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf 'ress         = /beagle/10.1.10.1\ninterface       = usb0\ndhcp-range      = 10.1' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf '.10.2,10.1.10.2,255.255.255.252,1m\nresolv-file     = /etc/resolv.conf\ndhcp-opt' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf 'ion     = vendor:MSFT,2,1i\ndhcp-option     = option:router,10.1.10.1\ndhcp-opti' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf 'on     = option:domain-search,usb\ndhcp-option     = option:domain-name,beagle.u' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf 'sb\nlisten-address  = 10.1.10.1\ndhcp-lease-max  = 1\ndhcp-leasefile  = /dev/nul' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
/usr/bin/printf 'l\n' >> "${ROOT}${SYSCONFIG_DIR}/etc/dnsmasq.conf"
