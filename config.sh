...
mkdir -p "${SETUP_DIRECTORY}/etc/systemd/systemd-resolved.service.d" 2> /dev/null
mkdir -p "${SETUP_DIRECTORY}/etc" 2> /dev/null
mkdir -p "${SETUP_DIRECTORY}/etc/tmpfiles.d" 2> /dev/null
...
/usr/bin/printf 't-files --plain --full --no-pager --legend=false | grep "masked" | awk '\''{prin' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 't $1}'\'' 1> "${SYSCONFIG}/masked.md"\nsystemctl list-unit-files --plain --full ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '--no-pager --legend=false | awk '\''{print $1" "$2}'\'' | grep "enabled" | grep ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '-vE ".target|enabled-runtime|@" | awk '\''{print $1}'\'' 1> "${SYSCONFIG}/units.' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'md"\nsystemctl list-units --plain --full --no-pager --legend=false | grep "@." |' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' grep -vE "dead|exited|etc-pacman\\.d-gnupg\\.service" | awk '\''{print $1}'\'' ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '| grep -vE "getty|user|blockdev" | grep "@." 1> "${SYSCONFIG}/indirect.md"\n\nch' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'own -R root:root "$SYSCONFIG"\nchmod -R 0555 "$SYSCONFIG"\n\nfind "$SYSCONFIG" -' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'type f -exec chmod 0444 {} \\;\nfind "$SYSCONFIG" -type d -exec chmod 0555 {} \\' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ';\n\nchmod -R 0555 "${SYSCONFIG}/bin"\nchmod -R 0555 "${SYSCONFIG}/etc/profile.d' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"\nchmod -R 0500 "${SYSCONFIG}/etc/syscheck.d"\n\nchmod 0555 "${SYSCONFIG}/etc/s' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'sh"\nchmod 0555 "${SYSCONFIG}/etc/systemd"\nchmod 0500 "${SYSCONFIG}/etc/sysctl.' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'd"\nchmod 0555 "${SYSCONFIG}/etc/security" 2> /dev/null\nchmod 0440 "${SYSCONFIG' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '}/etc/ssh/sshd_config"\nchmod 0400 "${SYSCONFIG}/etc/mkinitcpio.conf" 2> /dev/nu' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'll\nchmod 0500 "${SYSCONFIG}/etc/security/limits.d" 2> /dev/null\nchmod 0400 "${' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'SYSCONFIG}/etc/systemd/coredump.conf" 2> /dev/null\n\nchmod 0400 "${SYSCONFIG}"/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'etc/sysctl.d/*\nchmod 0444 "${SYSCONFIG}"/etc/systemd/network/* 2> /dev/null\nch' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'mod 0400 "${SYSCONFIG}"/etc/security/limits.d/* 2> /dev/null\n\nchmod -R 0555 "/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'etc/profile.d"\nchmod -R 0500 "/etc/syscheck.d"\n\nchmod 0555 "/etc/ssh"\nchmod ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '0555 "/etc/systemd"\nchmod 0500 "/etc/sysctl.d"\nchmod 0555 "/etc/security"\nchm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'od 0444 "/etc/resolv.conf"\nchmod 0500 "/etc/mkinitcpio.d" 2> /dev/null\nchmod 0' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '500 "/etc/pacman.d/hooks" 2> /dev/null\nchmod 0500 "/etc/security/limits.d" 2> /' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'dev/null\n\nchmod 0400 /etc/sysctl.d/*\nchmod 0400 /etc/mkinitcpio.d/* 2> /dev/n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ull\nchmod 0444 /etc/systemd/network/* 2> /dev/null\nchmod 0400 /etc/security/li' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'mits.d/* 2> /dev/null\n\nchown -R root:root "/etc/ssh"\nchown -R root:root "/etc' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '/systemd"\nchown -R root:root "/etc/sysctl.d"\nchown -R root:root "/etc/security' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"\nchown -R root:root "/etc/profile.d"\nchown -R root:root "/etc/syscheck.d"\nch' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'own -R root:root "/etc/resolv.conf"\n\nfind "/etc/ssh" -type f -exec chmod 0400 ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '{} \\;\nfind "/etc/systemd" -type f -exec chmod 0444 {} \\;\nfind "/etc/security' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '" -type f -exec chmod 0440 {} \\;\n\nif [ -e "/etc/pacman.conf" ]; then\n    chm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'od 0444 "${SYSCONFIG}/etc/pacman.conf"\n    chmod 0500 "${SYSCONFIG}/etc/pacman.' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'd/hooks"\n    chmod 0400 "${SYSCONFIG}"/etc/pacman.d/hooks/*\n    chmod 0555 "/e' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'tc/pacman.d"\n    chmod 0400 /etc/pacman.d/hooks/*\n    chown -R root:root "/etc' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '/pacman.d"\n    find "/etc/pacman.d" -maxdepth 1 -type f -exec chmod 0444 {} \\;' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nfi\nif [ -e "${SYSCONFIG}/etc/udev" ]; then\n    chown -R root:root "/etc/udev' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"\n    chmod -R 0555 "${SYSCONFIG}/etc/udev"\n    find "/etc/udev/" -xdev -type ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'f -exec chmod 0444 {} \\;\n    find "${SYSCONFIG}/etc/udev/" -xdev -type f -exec' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' chmod 0444 {} \\;\nfi\nif [ -e "${SYSCONFIG}/etc/tmpfiles.d" ]; then\n    chown' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' -R root:root "/etc/tmpfiles.d"\n    chmod 0550 "${SYSCONFIG}/etc/tmpfiles.d"\n ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '   chmod 0440 "${SYSCONFIG}"/etc/tmpfiles.d/*\n    chmod 0550 "/etc/tmpfiles.d"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '    chmod 0440 /etc/tmpfiles.d/*\nfi\nif [ -e "${SYSCONFIG}/etc/modprobe.d" ]; t' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'hen\n    chown -R root:root "/etc/modprobe.d"\n    chmod 0500 "${SYSCONFIG}/etc/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'modprobe.d"\n    chmod 0400 "${SYSCONFIG}"/etc/modprobe.d/*\n    chmod 0500 "/et' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c/modprobe.d"\nfi\nif [ -e "${SYSCONFIG}/etc/sysupdate.d" ]; then\n    chown -R ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'root:root "/etc/sysupdate.d"\n    chmod 0550 "${SYSCONFIG}/etc/sysupdate.d"\n   ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' chmod 0550 "${SYSCONFIG}"/etc/sysupdate.d/*\n    chmod 0550 "/etc/sysupdate.d"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'fi\nif [ -e "${SYSCONFIG}/etc/nftables.conf" ]; then\n    chmod 0400 "${SYSCONFI' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'G}/etc/nftables.conf"\nfi\n\nif [ -d "/etc/syscheck.d" ]; then\n    for entry in' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' /etc/syscheck.d/*.sh; do\n        if [ -f "$entry" ]; then\n            printf ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ''\''Processing script "%%s"..\\n'\'' "$entry"\n            source "$entry"\n    ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '    fi\n    done\nfi\n\nsync\necho "Broken Links Found:"\nfind /etc -xtype l -xd' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ev 2> /dev/null | grep -vE "/proc|/tmp|/run"\necho "Done!"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
...
/usr/bin/printf '#!/usr/bin/bash\n\nexport export HISTSIZE=500\nexport HISTFILESIZE=0\nexport HIS' >> "${SETUP_DIRECTORY}/etc/profile.d/history.sh"
/usr/bin/printf 'TFILE="/dev/null"\n\nexport LESSKEY="/etc/sysless"\nexport LESSHISTFILE="/dev/nu' >> "${SETUP_DIRECTORY}/etc/profile.d/history.sh"
/usr/bin/printf 'll"\n\nexport PYTHONPYCACHEPREFIX="/var/cache/python"\n' >> "${SETUP_DIRECTORY}/etc/profile.d/history.sh"

# Create file "/etc/profile.d/proxy.sh"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/profile.d/proxy.sh"
/usr/bin/printf '#!/usr/bin/bash\n\nexport http_proxy="http://host.usb:8050/"\nexport https_proxy' >> "${SETUP_DIRECTORY}/etc/profile.d/proxy.sh"
/usr/bin/printf '="http://host.usb:8050/"\nexport no_proxy="localhost,127.0.0.1,localaddress,.loc' >> "${SETUP_DIRECTORY}/etc/profile.d/proxy.sh"
/usr/bin/printf 'aldomain.com,.usb"\n' >> "${SETUP_DIRECTORY}/etc/profile.d/proxy.sh"
...
/usr/bin/printf 'vices() {\n    printf "# Network:\\t%%s Established, " "$(netstat -panut 2> /dev' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf '/null | grep -c "ESTABLISHED")"\n    printf "%%s Listening\\n" "$(netstat -panut' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf ' 2> /dev/null | grep -c "LISTEN")"\n    printf "# Services:\\t%%s Running, " "$(' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf 'systemctl --state=active --no-legend --no-pager | grep ".service" | grep -c "run' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf 'ning")"\n    printf "%%s Failed, " "$(systemctl --state=failed --no-legend --no-' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf 'pager | grep -c ".service")"\n    printf "%%s Timers\\n" "$(systemctl --all --no' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf '-legend --no-pager | grep -c ".timer")"\n}\n\nif [[ $- != *i* ]] || [ -n "$SSH_C' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf 'LIENT" ]; then\n    printf "####################################################' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf '##########\\n"\n    status_storage\n    status_network\n    printf "# Uptime:\\t' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf '%%s\\n" "$(uptime --pretty | sed '\''s/up //g'\'')"\n    printf "# Kernel:\\t%%s' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf '\\n" "$(uname -r)"\n    status_repo\n    status_services\n    printf "##########' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
/usr/bin/printf '####################################################\\n"\nfi\n' >> "${SETUP_DIRECTORY}/etc/profile.d/z_system_status.sh"
...
/usr/bin/printf 'ot "/var/cache/ld.so.cache"\n\nchmod -R 0770 "/var/cache/pacman/pkg"\nfind "/var' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf '/cache/pacman/pkg" -type f -exec chmod 0660 {} \\;\nchown -R root:alpm "/var/cac' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf 'he/pacman/pkg"\n\nchmod 0755 "/var/lib/pacman/sync"\nchmod 0644 /var/lib/pacman/' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf 'sync/*\nchown -R root:root "/var/lib/pacman/sync"\n\nchmod -R 0755 "/var/lib/pac' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf 'man/local"\nchown -R root:root "/var/lib/pacman/local"\nfind "/var/lib/pacman" -' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf 'type f -exec chmod 0644 {} \\;\n\nchmod 0700 "/var/cache/ldconfig"\nchown -R roo' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf 't:root "/var/cache/ldconfig"\n\nchmod 3777 "/var/cache/python"\nchown root:root ' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
/usr/bin/printf '"/var/cache/python"\n' >> "${SETUP_DIRECTORY}/etc/syscheck.d/cache.sh"
...
/usr/bin/printf 'net.ipv6.conf.all.disable_ipv6      = 1\nnet.ipv6.conf.usb0.disable_ipv6     = 1' >> "${SETUP_DIRECTORY}/etc/sysctl.d/ipv6.conf"
...
/usr/bin/printf 'vm.swappiness                    = 10\nfs.suid_dumpable                 = 0\nfs.' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'protected_fifos               = 1\nfs.protected_regular             = 1\nkernel.' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'kptr_restrict             = 2\nkernel.dmesg_restrict            = 1\nfs.protecte' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'd_symlinks            = 1\nfs.protected_hardlinks           = 1\nkernel.yama.ptr' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'ace_scope         = 3\nkernel.kexec_load_disabled       = 1\nfs.inotify.max_user' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf '_watches      = 16777215\nfs.inotify.max_queued_events     = 32767\nvm.dirty_wri' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'teback_centisecs     = 1500\nfs.inotify.max_user_instances    = 4096\nkernel.unp' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"
/usr/bin/printf 'rivileged_bpf_disabled = 1\n' >> "${SETUP_DIRECTORY}/etc/sysctl.d/kernel.conf"

# Create file "/etc/systemd/network/usb0.network"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/systemd/network/usb0.network"
/usr/bin/printf '[Match]\nType                = gadget\n\n[Link]\nActivationPolicy    = always-up' >> "${SETUP_DIRECTORY}/etc/systemd/network/usb0.network"
/usr/bin/printf '\n\n[Network]\nDNS                 = 10.1.10.2\nAddress             = 10.1.10.1/' >> "${SETUP_DIRECTORY}/etc/systemd/network/usb0.network"
/usr/bin/printf '30\nIPv6AcceptRA        = no\nLinkLocalAddressing = no\n\n[Route]\nGateway      ' >> "${SETUP_DIRECTORY}/etc/systemd/network/usb0.network"
/usr/bin/printf '       = 10.1.10.1\nGatewayOnLink       = yes' >> "${SETUP_DIRECTORY}/etc/systemd/network/usb0.network"
...
/usr/bin/printf '[Service]\nExecStart      =\nExecStart      = -/usr/bin/archlinux-keyring-wkd-sy' >> "${SETUP_DIRECTORY}/etc/systemd/system/archlinux-keyring-wkd-sync.service.d/override.conf"
/usr/bin/printf 'nc\nReadWritePaths = /var/db/pacman/gnupg/\n' >> "${SETUP_DIRECTORY}/etc/systemd/system/archlinux-keyring-wkd-sync.service.d/override.conf"
...
/usr/bin/printf '    = volatile\nReadKMsg            = yes\nCompress            = yes\nSplitMode ' >> "${SETUP_DIRECTORY}/etc/systemd/journald.conf"
/usr/bin/printf '          = uid\nMaxFileSec          = 12h\nSystemMaxUse        = 64M\nMaxLevelS' >> "${SETUP_DIRECTORY}/etc/systemd/journald.conf"
/usr/bin/printf 'tore       = info\nForwardToSyslog     = no\nMaxRetentionSec     = 12h\nSystemMa' >> "${SETUP_DIRECTORY}/etc/systemd/journald.conf"
/usr/bin/printf 'xFileSize   = 32M\n' >> "${SETUP_DIRECTORY}/etc/systemd/journald.conf"
...
/usr/bin/printf 'DNSSEC                      = allow-downgrade\nDomains                     = usb' >> "${SETUP_DIRECTORY}/etc/systemd/resolved.conf"
/usr/bin/printf '\nDNSOverTLS                  = no\nFallbackDNS                 = 127.0.0.1\nRea' >> "${SETUP_DIRECTORY}/etc/systemd/resolved.conf"
/usr/bin/printf 'dEtcHosts                = yes\nMulticastDNS                = no\nDNSStubListene' >> "${SETUP_DIRECTORY}/etc/systemd/resolved.conf"
...
# Create file "/etc/systemd/systemd-resolved.service.d/override.conf"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/systemd/systemd-resolved.service.d/override.conf"
/usr/bin/printf '[Unit]\nAfter    = var.mount\nRequires = var.mount\n' >> "${SETUP_DIRECTORY}/etc/systemd/systemd-resolved.service.d/override.conf"

# Create file "/etc/dnsmasq.conf"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'no-ping\nbind-dynamic\nexpand-hosts\ndnssec-no-timecheck\n\nport            = 53' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf '\nuser            = dnsmasq\ngroup           = dnsmasq\nlocal           = /usb/\n' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'domain          = usb,10.1.10.1/30\naddress         = /beagle.usb/10.1.10.1\nadd' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'ress         = /beagle/10.1.10.1\ninterface       = usb0\ndhcp-range      = 10.1' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf '.10.2,10.1.10.2,255.255.255.252,1m\nresolv-file     = /etc/resolv.conf\ndhcp-opt' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'ion     = vendor:MSFT,2,1i\ndhcp-option     = option:router,10.1.10.1\ndhcp-opti' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'on     = option:domain-search,usb\ndhcp-option     = option:domain-name,beagle.u' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'sb\nlisten-address  = 10.1.10.1\ndhcp-lease-max  = 1\ndhcp-leasefile  = /dev/nul' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"
/usr/bin/printf 'l\n' >> "${SETUP_DIRECTORY}/etc/dnsmasq.conf"

# Create file "/etc/hostname"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/hostname"
/usr/bin/printf 'beagle' >> "${SETUP_DIRECTORY}/etc/hostname"
...
/usr/bin/printf 'host\n\n10.1.10.1   beagle.usb          beagle\n10.1.10.2   host.usb            ' >> "${SETUP_DIRECTORY}/etc/hosts"
...
/usr/bin/printf '[options]\nDBPath              = /var/lib/pacman\nGPGDir              = /var/db/' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'pacman/gnupg\nRootDir             = /\nHookDir             = /etc/pacman.d/hooks' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '\nLogFile             = /var/log/pacman.log\nHoldPkg             = pacman glibc\n' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'CacheDir            = /var/cache/pacman/pkg\nSigLevel            = Required Data' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'baseOptional\nCleanMethod         = KeepInstalled\nArchitecture        = armv7h\n' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'ParallelDownloads   = 5\nLocalFileSigLevel   = Optional\n\nNoExtract           =' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf ' usr/share/locale/* usr/share/X11/locale/*/* usr/share/i18n/locales/* opt/google' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '/chrome/locales/* !usr/share/X11/locale/C/*\nNoExtract           = !usr/share/X1' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '1/locale/compose.dir !usr/share/X11/locale/iso8859-1/*\nNoExtract           = !*' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'locale*/en*/* !usr/share/*locale*/locale.*\nNoExtract           = !usr/share/*lo' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'cales/en_?? !usr/share/*locales/i18n* !usr/share/*locales/iso*\nNoExtract       ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '    = usr/share/i18n/charmaps/* !usr/share/i18n/charmaps/UTF-8.gz !usr/share/i18' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'n/charmaps/ANSI_X3.4-1968.gz !usr/share/i18n/charmaps/ISO-8859-1.gz\nNoExtract  ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '         = !usr/share/*locales/trans*\nNoExtract           = !usr/share/*locales' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '/C !usr/share/*locales/POSIX\nNoExtract           = usr/share/vim/vim*/lang/*\nN' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'oExtract           = usr/share/gtk-doc/html/*\nNoExtract           = usr/share/d' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'oc/HTML/*\nNoExtract           = usr/share/help/* !usr/share/help/C/*\n\nVerbose' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'PkgLists\n\n[aur]\nInclude             = /etc/pacman.d/mirrorlist\n[core]\nInclu' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'de             = /etc/pacman.d/mirrorlist\n[extra]\nInclude             = /etc/p' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'acman.d/mirrorlist\n[alarm]\nInclude             = /etc/pacman.d/mirrorlist\n[co' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'mmunity]\nInclude             = /etc/pacman.d/mirrorlist\n' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
...
/usr/bin/printf 'UMASK                   0027\nMAIL_DIR                /var/spool/mail\nMOTD_FILE' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '\nHOME_MODE               0700\nFAIL_DELAY              3\nCREATE_HOME          ' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '   no\nNONEXISTENT             /nonexistent\nDEFAULT_HOME            yes\nFORCE_' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'SHADOW            yes\nCHFN_RESTRICT           rwh\nENCRYPT_METHOD          YESC' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'RYPT\nHUSHLOGIN_FILE          .config/hushlogin\nUSERGROUPS_ENAB         yes\nHM' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'AC_CRYPTO_ALGO        SHA512\nLOG_UNKFAIL_ENAB        no\nYESCRYPT_COST_FACTOR  ' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '  5\nMAX_MEMBERS_PER_GROUP   0\nGRANT_AUX_GROUP_SUBIDS  yes\n\nENV_PATH         ' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '       PATH=/usr/local/sbin:/usr/local/bin:/usr/bin\nENV_SUPATH              PAT' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'H=/usr/local/sbin:/usr/bin\n\nTTYPERM                 0620\nTTYGROUP            ' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '    tty\n\nPASS_MAX_DAYS           99999\nPASS_MIN_DAYS           0\nPASS_WARN_A' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'GE           14\n\nLOGIN_RETRIES           5\nLOGIN_TIMEOUT           120\n\nUID' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '_MIN                 1000\nUID_MAX                 60000\n\nGID_MIN             ' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '    1000\nGID_MAX                 60000\n\nSYS_UID_MIN             500\nSYS_UID_' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'MAX             999\nSUB_UID_MIN             100000\nSUB_UID_MAX             600' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '100000\nSUB_UID_COUNT           65536\n\nSYS_GID_MIN             500\nSYS_GID_MA' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'X             999\nSUB_GID_MIN             100000\nSUB_GID_MAX             60010' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf '0000\nSUB_GID_COUNT           65536\n\nSHA_CRYPT_MIN_ROUNDS    5000\nSHA_CRYPT_M' >> "${SETUP_DIRECTORY}/etc/login.defs"
/usr/bin/printf 'AX_ROUNDS    5000\n' >> "${SETUP_DIRECTORY}/etc/login.defs"
...
# Create file "/etc/tmpfiles.d/cache.conf"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/tmpfiles.d/cache.conf"
/usr/bin/printf 'd /var/cache/python 3777 root root - -\n' >> "${SETUP_DIRECTORY}/etc/tmpfiles.d/cache.conf"
