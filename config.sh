...
/usr/bin/printf '-vE ".target|enabled-runtime" | awk '\''{print $1}'\'' 1> "${SYSCONFIG}/units.md' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"\nsystemctl list-units --plain --full --no-pager --legend=false | grep "@." | g' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'rep -vE "dead|exited|etc-pacman\\.d-gnupg\\.service" | awk '\''{print $1}'\'' | ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'grep -vE "getty|user|blockdev" | grep "@." 1> "${SYSCONFIG}/indirect.md"\n\nchow' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'n -R root:root "$SYSCONFIG"\nchmod -R 0555 "$SYSCONFIG"\n\nfind "$SYSCONFIG" -ty' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'pe f -exec chmod 0444 {} \\;\nfind "$SYSCONFIG" -type d -exec chmod 0555 {} \\;\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nchmod -R 0555 "${SYSCONFIG}/bin"\nchmod -R 0555 "${SYSCONFIG}/etc/profile.d"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod -R 0500 "${SYSCONFIG}/etc/syscheck.d"\n\nchmod 0555 "${SYSCONFIG}/etc/ssh"' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nchmod 0555 "${SYSCONFIG}/etc/systemd"\nchmod 0500 "${SYSCONFIG}/etc/sysctl.d"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod 0555 "${SYSCONFIG}/etc/security" 2> /dev/null\nchmod 0440 "${SYSCONFIG}/et' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c/ssh/sshd_config"\nchmod 0400 "${SYSCONFIG}/etc/mkinitcpio.conf" 2> /dev/null\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod 0500 "${SYSCONFIG}/etc/security/limits.d" 2> /dev/null\nchmod 0400 "${SYSC' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ONFIG}/etc/systemd/coredump.conf" 2> /dev/null\n\nchmod 0400 "${SYSCONFIG}"/etc/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'sysctl.d/*\nchmod 0444 "${SYSCONFIG}"/etc/systemd/network/* 2> /dev/null\nchmod ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '0400 "${SYSCONFIG}"/etc/security/limits.d/* 2> /dev/null\n\nchmod -R 0555 "/etc/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'profile.d"\nchmod -R 0500 "/etc/syscheck.d"\n\nchmod 0555 "/etc/ssh"\nchmod 0555' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' "/etc/systemd"\nchmod 0500 "/etc/sysctl.d"\nchmod 0555 "/etc/security"\nchmod 0' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '444 "/etc/resolv.conf"\nchmod 0500 "/etc/mkinitcpio.d" 2> /dev/null\nchmod 0500 ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"/etc/pacman.d/hooks" 2> /dev/null\nchmod 0500 "/etc/security/limits.d" 2> /dev/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'null\n\nchmod 0400 /etc/sysctl.d/*\nchmod 0400 /etc/mkinitcpio.d/* 2> /dev/null\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod 0444 /etc/systemd/network/* 2> /dev/null\nchmod 0400 /etc/security/limits.' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'd/* 2> /dev/null\n\nchown -R root:root "/etc/ssh"\nchown -R root:root "/etc/syst' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'emd"\nchown -R root:root "/etc/sysctl.d"\nchown -R root:root "/etc/security"\nch' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'own -R root:root "/etc/profile.d"\nchown -R root:root "/etc/syscheck.d"\nchown -' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'R root:root "/etc/resolv.conf"\n\nfind "/etc/ssh" -type f -exec chmod 0400 {} \\' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ';\nfind "/etc/systemd" -type f -exec chmod 0444 {} \\;\nfind "/etc/security" -ty' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'pe f -exec chmod 0440 {} \\;\n\nif [ -e "/etc/pacman.conf" ]; then\n    chmod 04' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '44 "${SYSCONFIG}/etc/pacman.conf"\n    chmod 0500 "${SYSCONFIG}/etc/pacman.d/hoo' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ks"\n    chmod 0400 "${SYSCONFIG}"/etc/pacman.d/hooks/*\n    chmod 0555 "/etc/pa' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'cman.d"\n    chmod 0400 /etc/pacman.d/hooks/*\n    chown -R root:root "/etc/pacm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'an.d"\n    find "/etc/pacman.d" -maxdepth 1 -type f -exec chmod 0444 {} \\;\nfi\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'if [ -e "${SYSCONFIG}/etc/udev" ]; then\n    chown -R root:root "/etc/udev"\n   ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' chmod -R 0555 "${SYSCONFIG}/etc/udev"\n    find "/etc/udev/" -xdev -type f -exe' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c chmod 0444 {} \\;\n    find "${SYSCONFIG}/etc/udev/" -xdev -type f -exec chmod' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' 0444 {} \\;\nfi\nif [ -e "${SYSCONFIG}/etc/tmpfiles.d" ]; then\n    chown -R ro' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ot:root "/etc/tmpfiles.d"\n    chmod 0550 "${SYSCONFIG}/etc/tmpfiles.d"\n    chm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'od 0440 "${SYSCONFIG}"/etc/tmpfiles.d/*\n    chmod 0550 "/etc/tmpfiles.d"\n    c' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'hmod 0440 /etc/tmpfiles.d/*\nfi\nif [ -e "${SYSCONFIG}/etc/modprobe.d" ]; then\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '    chown -R root:root "/etc/modprobe.d"\n    chmod 0500 "${SYSCONFIG}/etc/modpr' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'obe.d"\n    chmod 0400 "${SYSCONFIG}"/etc/modprobe.d/*\n    chmod 0500 "/etc/mod' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'probe.d"\nfi\nif [ -e "${SYSCONFIG}/etc/sysupdate.d" ]; then\n    chown -R root:' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'root "/etc/sysupdate.d"\n    chmod 0550 "${SYSCONFIG}/etc/sysupdate.d"\n    chmo' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'd 0550 "${SYSCONFIG}"/etc/sysupdate.d/*\n    chmod 0550 "/etc/sysupdate.d"\nfi\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'if [ -e "${SYSCONFIG}/etc/nftables.conf" ]; then\n    chmod 0400 "${SYSCONFIG}/e' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'tc/nftables.conf"\nfi\n\nif [ -d "/etc/syscheck.d" ]; then\n    for entry in /et' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c/syscheck.d/*.sh; do\n        if [ -f "$entry" ]; then\n            printf '\''' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'Processing script "%%s"..\\n'\'' "$entry"\n            source "$entry"\n        ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'fi\n    done\nfi\n\nsync\necho "Broken Links Found:"\nfind /etc -xtype l -xdev 2' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '> /dev/null | grep -vE "/proc|/tmp|/run"\necho "Done!"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
