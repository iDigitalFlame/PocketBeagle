...
/usr/bin/printf 'IG}/units.md"\nsystemctl list-units | grep "@." | grep -vE "dead|exited|etc-pacm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'an\\.d-gnupg\\.service" | awk '\''{print $1}'\'' | grep -vE "getty|user|blockdev' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '" | grep "@." | sort 1> "${SYSCONFIG}/indirect.md"\n\nchown -R root:root "$SYSCO' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'NFIG"\nchmod -R 0555 "$SYSCONFIG"\n\nfind "$SYSCONFIG" -type f -exec chmod 0444 ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '{} \\;\nfind "$SYSCONFIG" -type d -exec chmod 0555 {} \\;\n\nchmod -R 0555 "${SY' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'SCONFIG}/bin"\nchmod -R 0555 "${SYSCONFIG}/etc/profile.d"\nchmod -R 0500 "${SYSC' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ONFIG}/etc/syscheck.d"\n\nchmod 0555 "${SYSCONFIG}/etc/ssh"\nchmod 0555 "${SYSCO' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'NFIG}/etc/systemd"\nchmod 0500 "${SYSCONFIG}/etc/sysctl.d"\nchmod 0555 "${SYSCON' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'FIG}/etc/security" 2> /dev/null\nchmod 0440 "${SYSCONFIG}/etc/ssh/sshd_config"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod 0400 "${SYSCONFIG}/etc/mkinitcpio.conf" 2> /dev/null\nchmod 0500 "${SYSCON' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'FIG}/etc/security/limits.d" 2> /dev/null\nchmod 0400 "${SYSCONFIG}/etc/systemd/c' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'oredump.conf" 2> /dev/null\n\nchmod 0400 "${SYSCONFIG}"/etc/sysctl.d/*\nchmod 04' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '44 "${SYSCONFIG}"/etc/systemd/network/* 2> /dev/null\nchmod 0400 "${SYSCONFIG}"/' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'etc/security/limits.d/* 2> /dev/null\n\nchmod -R 0555 "/etc/profile.d"\nchmod -R' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' 0500 "/etc/syscheck.d"\n\nchmod 0555 "/etc/ssh"\nchmod 0555 "/etc/systemd"\nchm' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'od 0500 "/etc/sysctl.d"\nchmod 0555 "/etc/security"\nchmod 0444 "/etc/resolv.con' >> "${SETUP_DIRECTORY}/bin/syslink"
...
/usr/bin/printf 'etc/sysctl.d/*\nchmod 0400 /etc/mkinitcpio.d/* 2> /dev/null\nchmod 0444 /etc/sys' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'temd/network/* 2> /dev/null\nchmod 0400 /etc/security/limits.d/* 2> /dev/null\n\n' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chown -R root:root "/etc/ssh"\nchown -R root:root "/etc/systemd"\nchown -R root:' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'root "/etc/sysctl.d"\nchown -R root:root "/etc/security"\nchown -R root:root "/e' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'tc/profile.d"\nchown -R root:root "/etc/syscheck.d"\nchown -R root:root "/etc/re' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'solv.conf"\n\nfind "/etc/ssh" -type f -exec chmod 0400 {} \\;\nfind "/etc/system' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'd" -type f -exec chmod 0444 {} \\;\nfind "/etc/security" -type f -exec chmod 044' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '0 {} \\;\n\nif [ -e "/etc/pacman.conf" ]; then\n    chmod 0444 "${SYSCONFIG}/etc' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '/pacman.conf"\n    chmod 0500 "${SYSCONFIG}/etc/pacman.d/hooks"\n    chmod 0400 ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '"${SYSCONFIG}"/etc/pacman.d/hooks/*\n    chmod 0555 "/etc/pacman.d"\n    chmod 0' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '400 /etc/pacman.d/hooks/*\n    chown -R root:root "/etc/pacman.d"\n    find "/et' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c/pacman.d" -maxdepth 1 -type f -exec chmod 0444 {} \\;\nfi\nif [ -e "${SYSCONFI' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'G}/etc/udev" ]; then\n    chown -R root:root "/etc/udev"\n    chmod -R 0555 "${S' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'YSCONFIG}/etc/udev"\n    find "/etc/udev/" -xdev -type f -exec chmod 0444 {} \\;' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nfi\nif [ -e "${SYSCONFIG}/etc/tmpfiles.d" ]; then\n    chown -R root:root "/et' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'c/tmpfiles.d"\n    chmod 0550 "${SYSCONFIG}/etc/tmpfiles.d"\n    chmod 0440 "${S' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'YSCONFIG}"/etc/tmpfiles.d/*\n    chmod 0550 "/etc/tmpfiles.d"\n    chmod 0440 /e' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'tc/tmpfiles.d/*\nfi\nif [ -e "${SYSCONFIG}/etc/modprobe.d" ]; then\n    chown -R' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf ' root:root "/etc/modprobe.d"\n    chmod 0500 "${SYSCONFIG}/etc/modprobe.d"\n    ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'chmod 0400 "${SYSCONFIG}"/etc/modprobe.d/*\n    chmod 0500 "/etc/modprobe.d"\nfi' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nif [ -e "${SYSCONFIG}/etc/sysupdate.d" ]; then\n    chown -R root:root "/etc/s' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'ysupdate.d"\n    chmod 0550 "${SYSCONFIG}/etc/sysupdate.d"\n    chmod 0550 "${SY' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'SCONFIG}"/etc/sysupdate.d/*\n    chmod 0550 "/etc/sysupdate.d"\nfi\nif [ -e "${S' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'YSCONFIG}/etc/nftables.conf" ]; then\n    chmod 0400 "${SYSCONFIG}/etc/nftables.' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'conf"\nfi\n\nif [ -d "/etc/syscheck.d" ]; then\n    for entry in /etc/syscheck.d' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '/*.sh; do\n        if [ -f "$entry" ]; then\n            printf '\''Processing s' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf 'cript "%%s"..\\n'\'' "$entry"\n            source "$entry"\n        fi\n    done' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '\nfi\n\nsync\necho "Broken Links Found:"\nfind /etc -xtype l -xdev 2> /dev/null ' >> "${SETUP_DIRECTORY}/bin/syslink"
/usr/bin/printf '| grep -vE "/proc|/tmp|/run"\necho "Done!"\n' >> "${SETUP_DIRECTORY}/bin/syslink"
