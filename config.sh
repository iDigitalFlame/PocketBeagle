...
/usr/bin/printf 'n/charmaps/ANSI_X3.4-1968.gz\nNoExtract           = !usr/share/*locales/trans*\n' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'NoExtract           = !usr/share/*locales/C !usr/share/*locales/POSIX\nNoExtract' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '           = usr/share/vim/vim*/lang/*\nNoExtract           = usr/share/gtk-doc/' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'html/*\nNoExtract           = usr/share/doc/HTML/*\nNoExtract           = usr/sh' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'are/help/* !usr/share/help/C/*\n\nVerbosePkgLists\n\n[aur]\nInclude             ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '= /etc/pacman.d/mirrorlist\n[core]\nInclude             = /etc/pacman.d/mirrorli' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'st\n[extra]\nInclude             = /etc/pacman.d/mirrorlist\n[alarm]\nInclude   ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '          = /etc/pacman.d/mirrorlist\n[community]\nInclude             = /etc/pa' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'cman.d/mirrorlist\n' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
